echo off
REM This file installs the git-version of "ComfyUI" + "ComfyUI-Manager" with "torch-cuda" + "xFormers" for NVIDIA videocards.
cls
...
%scripts%\python -m pip install torch==2.1.2 torchvision==0.16.2 torchaudio==2.1.2 --index-url https://download.pytorch.org/whl/cu121
echo ======================================
echo Installing GPU-cuda xFormers python packages
%scripts%\python -m pip install -U xformers==0.0.23.post1 --index-url https://download.pytorch.org/whl/cu121
echo ======================================
